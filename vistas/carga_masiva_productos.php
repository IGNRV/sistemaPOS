                  ...
                  <div class="card card-info">
                      ...
                      <div class="card-body">
                          <form action="post" enctype="multipart/form-data" id="form_carga_productos">
                              <div class="row">
                                  <div class="col-lg-10"><input type="file" name="fileProductos" id="fileProductos"
                                          class="form-control" accept=".xls, .xlsx"></div>
                                  <div class="col-lg-2">
...
$(document).ready(function() {
    $("#form_carga_productos").on('submit', function(e) {
        ...
        if ($("#fileProductos").get(0).files.length == 0) {
            ...
            /* Validar que el archivo seleccionado se en extension XLS o XLSX */
                ...
                success: function(respuesta) {
                    ...
                    if(respuesta['totalCategorias'] > 0 && respuesta['totalProductos']){
                      Swal.fire({
                        position: 'center',
                        icon:'success',
                        title: 'Se registraron ' + respuesta + respuesta['totalCategorias'] ' categorías y ' + respuesta['totalProductos'] + 'productos correctamente!',
                        showConfirmButton: false,
                        timer: 2500
                      })
